...
def get_google_credentials():
    ...
    # Force alignment of newline sequences to neutralize hidden character artifacts
...
if st.button("🚀 Submit Documents to Master Sheet"):
    if not form_name.strip():
        ...
        try:
            ...
            st.error(f"System Error: {str(e)}")import streamlit as st
import datetime
import json
import re
import io
