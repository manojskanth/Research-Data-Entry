...
def get_google_credentials():\
    ...
    \
    # Securely translate encoded string sequences into true cryptographic breaks\
...
st.set_page_config(page_title="Portal", page_icon="\uc0\u55358 \u56598 ", layout="centered")\
\
st.title("\uc0\u55356 \u57314  St. Mary's Smart Research Desk")\
...
\
if st.button("\uc0\u55357 \u56960  Submit Documents to Master Sheet"):\
    if not form_name.strip():\
        ...
        try:\
            ...
            for index, file in enumerate(uploaded_files):\
                status_text.markdown(f"\uc0\u55358 \u56598  **Analyzing:** `\{file.name\}`...")\
...
\
            status_text.empty()\
            progress_bar.empty()\
            st.success(f"\uc0\u55356 \u57225  Complete for '\{form_year\}'!")\
            st.balloons()\
            \
        except Exception as e:\
